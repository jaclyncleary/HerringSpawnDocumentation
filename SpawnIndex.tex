...
% 8. Rename: bottom to substrate, vegetation to algae
...
Herring spawns typically extend along the shore; from above they spawns to be bands running parallel to the shore.
It is from this perspective that we define the spawn `length' and `width': length usually refers to distances parallel to the shore, and width usually refers to distances perpendicular to the shore.
Thus, Macrocystis length, $LengthMacroT$ and vegetation length, $LengthVegS$ refer to the distance that Macrocystis and vegetation extend parallel to the shore, respectively.
...
Next, transects are generally set $200\,\text{m}$ in from the ends of the spawn, and spaced $350\,\text{m}$ apart along the length.
