...
% TODO: Check if emails and phone numbers are required
\newcommand{\trTitle}{Calculating spawn indices for Pacific herring (\!\emph{Clupea pallasii}) in British Columbia, Canada}
