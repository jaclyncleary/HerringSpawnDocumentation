...
MT: Maybe this statement can lead off the paragraph, along with some background on how the spawn assessment is used in the stock assessment.
...
MT: (Schweigert, 1993...good description on the history of surface surveys and time length)
...
MT: (Surface surveys play a role in early/late spawns, hard to reach areas {outside SAR's}, man-power availibility --- never heard of this reference to spawns in shallow waters)
...
MT: (Schweigert, 1993) "Snorkeling and scuba surveys indicated the existence of significant amounts of subtidal spawn which were overlooked using the traditional surface-based technique"  "Diving surveys of egg deposition provided improved estimates of stock abundance and routine monitoring surveys were expanded coastwide in 1988"
...
MT: (Schweigert, 1993 - reference to early work by Hart & Tester)
...
MT: Immature fronds are considered less than 1m high and normally have a gummy coating (immatures are recorded but not used for any calculations).  Stipes less than 10cm high and dead stipes are ignored by the divers.  Reference Herring Spawn Survey manual, Fort, Daniel, Thompson, 2017}
...
\begin{multline}
EggsDVeg = 600.567 \times VegLayers^{0.6355} \times VegProp^{1.4130} \times V \times 1.0512
% Theres actually another parameter here: Q=1.0512 for 0.5m^2 quadrats (and other values for different sizes, but none are used in the code.. why?)
