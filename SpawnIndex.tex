...
I suspect this isn't necessary, and would open up a lot of unnecessary history.}
...
\begin{itemize}
%\item Ashleen Benson for translating the \textbf{Microsoft Access} database to an \textbf{R} script which we used to write \texttt{SpawnIndex.R}
