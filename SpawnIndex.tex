...
Finally, in the last section, we combine the three spawn indices to a total annual spawn index by SAR, which is the scale for Pacific herring stock assessments in BC.
