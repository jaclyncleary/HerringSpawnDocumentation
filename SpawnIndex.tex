...
\input{Document/CoverPage.tex}  % Cover page (input required)
\input{Document/TechReportPage.tex}  % Tech report page
\input{Document/InsideCoverPage.tex}  % Inside cover page (input required)
...
\input{Document/AbstractPage.tex}  % Abstact and resume page (input required)
