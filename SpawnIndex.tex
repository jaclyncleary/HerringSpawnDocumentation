...
\begin{itemize}
\item Brief description of surface spawn surveys, and types of data collected.%
...
Maybe the full details, including for example, the rational for transect and quadrat size and interval, should be in a separate Technical Report so that we can reference it? 
Maybe Matt T can give a brief description here, and for the other two surveys?}
...
\begin{itemize}
\item Brief description of Macrocystis spawn surveys, and types of data collected.
...
\begin{itemize}
\item Brief description of Understory spawn surveys, and types of data collected.
